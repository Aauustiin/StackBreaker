...
000003b0 <_start>:
 ...
 3c6:	8d 83 d4 e5 ff ff    	lea    -0x1a2c(%ebx),%eax
 3cc:	50                   	push   %eax
 3cd:	8d 83 74 e5 ff ff    	lea    -0x1a8c(%ebx),%eax
 3d3:	50                   	push   %eax
 3d4:	51                   	push   %ecx
 3d5:	56                   	push   %esi
...
000004ed <rec_func>:
 ...
 4f3:	e8 4f 00 00 00       	call   547 <__x86.get_pc_thunk.ax>
 4f8:	05 e4 1a 00 00       	add    $0x1ae4,%eax
 4fd:	8b 45 08             	mov    0x8(%ebp),%eax
 500:	83 e8 01             	sub    $0x1,%eax
 503:	83 ec 0c             	sub    $0xc,%esp
 506:	50                   	push   %eax
 507:	e8 e1 ff ff ff       	call   4ed <rec_func>
...
00000512 <main>:
 512:	8d 4c 24 04          	lea    0x4(%esp),%ecx
 516:	83 e4 f0             	and    $0xfffffff0,%esp
 519:	ff 71 fc             	pushl  -0x4(%ecx)
 51c:	55                   	push   %ebp
 51d:	89 e5                	mov    %esp,%ebp
 51f:	51                   	push   %ecx
 520:	83 ec 04             	sub    $0x4,%esp
 523:	e8 1f 00 00 00       	call   547 <__x86.get_pc_thunk.ax>
 528:	05 b4 1a 00 00       	add    $0x1ab4,%eax
 52d:	83 ec 0c             	sub    $0xc,%esp
 530:	6a 0a                	push   $0xa
 532:	e8 b6 ff ff ff       	call   4ed <rec_func>
 537:	83 c4 10             	add    $0x10,%esp
 53a:	b8 00 00 00 00       	mov    $0x0,%eax
 53f:	8b 4d fc             	mov    -0x4(%ebp),%ecx
 542:	c9                   	leave  
 543:	8d 61 fc             	lea    -0x4(%ecx),%esp
 546:	c3                   	ret    

00000547 <__x86.get_pc_thunk.ax>:
 547:	8b 04 24             	mov    (%esp),%eax
 54a:	c3                   	ret    
...
00000550 <__libc_csu_init>:
 ...
 552:	56                   	push   %esi
 553:	53                   	push   %ebx
 554:	e8 97 fe ff ff       	call   3f0 <__x86.get_pc_thunk.bx>
 559:	81 c3 83 1a 00 00    	add    $0x1a83,%ebx
 55f:	83 ec 0c             	sub    $0xc,%esp
 562:	8b 6c 24 28          	mov    0x28(%esp),%ebp
 566:	8d b3 04 ff ff ff    	lea    -0xfc(%ebx),%esi
 56c:	e8 e7 fd ff ff       	call   358 <_init>
 571:	8d 83 00 ff ff ff    	lea    -0x100(%ebx),%eax
 577:	29 c6                	sub    %eax,%esi
 579:	c1 fe 02             	sar    $0x2,%esi
 57c:	85 f6                	test   %esi,%esi
 57e:	74 25                	je     5a5 <__libc_csu_init+0x55>
 580:	31 ff                	xor    %edi,%edi
 582:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 588:	83 ec 04             	sub    $0x4,%esp
 58b:	55                   	push   %ebp
 58c:	ff 74 24 2c          	pushl  0x2c(%esp)
 590:	ff 74 24 2c          	pushl  0x2c(%esp)
 594:	ff 94 bb 00 ff ff ff 	call   *-0x100(%ebx,%edi,4)
 59b:	83 c7 01             	add    $0x1,%edi
 59e:	83 c4 10             	add    $0x10,%esp
 5a1:	39 fe                	cmp    %edi,%esi
...
000005b4 <_fini>:
 ...
 5b8:	e8 33 fe ff ff       	call   3f0 <__x86.get_pc_thunk.bx>
 5bd:	81 c3 1f 1a 00 00    	add    $0x1a1f,%ebx
 5c3:	83 c4 08             	add    $0x8,%esp
 5c6:	5b                   	pop    %ebx
 5c7:	c3                   	ret    
